        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          >
            {stats.map((stat, index) => {
              ...
              const total = stat.compareWithTotal
                ? calculateStats().currentPeriod[stat.compareWithTotal]
                : null;
              ...
              return (
                ...
                >
                  <Card
                    className={`dashboard-card ${stat.color} border ${stat.borderColor} overflow-hidden`}
                  >
                    <CardHeader className="pb-2">
                      <div className="flex items-center justify-between">
                        <CardTitle className="stat-label text-sm font-medium">
                          {stat.title}
                        </CardTitle>
          ...
          >
            ...
            <Card className="glass-card animate-scale-in">
              <CardHeader>
                ...
                <CardDescription>
                  Completion percentage by schedule
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[200px]">
