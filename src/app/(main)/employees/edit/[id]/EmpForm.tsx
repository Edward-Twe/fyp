...
import { User, CheckCircle2, Mail, MapPin, AlertCircle } from "lucide-react";
      ...
      <div className="flex h-full w-full items-center justify-center p-8">
        <div className="animate-pulse-opacity text-theme-blue-500 dark:text-theme-blue-400">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-medium">Loading Employee...</p>
          </div>
        </div>
      </div>
    )
    ...
    return (
      <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
        <div className="glass-card max-w-md p-8 animate-fade-in">
          ...
          <p className="mb-6 text-muted-foreground">Please select or create an organization to edit employees.</p>
    ...
    return (
      <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
        <div className="glass-card max-w-md p-8 animate-fade-in">
          ...
          <h1 className="mb-4 text-2xl font-bold">Employee Not Found</h1>
          <p className="mb-6 text-muted-foreground">The employee you&apos;re looking for doesn&apos;t exist or has been removed.</p>
          <Link href="/employees" className="btn-primary inline-flex items-center justify-center w-full">
            Return to Employees
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="container max-w-2xl mx-auto py-10 px-4 animate-fade-in">
      <div className="mb-8 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gradient">Edit Employee</h1>
