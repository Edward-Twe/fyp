                        ...
                        <div className="flex items-center gap-2">
                          {column.id !== "jobOrders" ? (
                            <>
                              <HoverCard>
                                <HoverCardTrigger>
                                  <h3 className="cursor-help text-lg font-semibold">
                                    {column.title}
                                  </h3>
                                </HoverCardTrigger>
                                <HoverCardContent>
                        ...
                        {column.id !== "jobOrders" && (
                          <div className="flex gap-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleOptimizeRoute(column.id, column)
                              }
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                handleMapClick(column.title, column.id, column)
                              }
                              disabled={column.jobOrders.length === 0 || !depot}
                            >
                                                ...
                                                <DropdownMenuContent align="end">
                                                  ...
                                                  <DropdownMenuItem
                                                    ...
                                                    onClick={async () => {
                                                      ...
                                                      const result = await updateJobOrderStatus(order.id, Status.inprogress);
                                                      setLoading(false);
                                                  ...
                                                  <DropdownMenuItem
                                                    ...
                                                    onClick={async () => {
                                                      ...
                                                      const result = await updateJobOrderStatus(order.id, Status.completed);
                                                      setLoading(false);
